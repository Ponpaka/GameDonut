...
public class DonutRush extends JPanel implements Runnable, KeyListener {
    ...
    public DonutRush(Main main) {
        ...
        //Boul label
        boul = new JLabel(new ImageIcon("Pic//Boul.png"));
        ...
        for (int i = 0; i < 5; i++) {
            labelLife[i] = new JLabel(new ImageIcon("Pic//heart.png"));
